...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#049596ae#;
   ...
   u00244 : constant Version_32 := 16#da6d40c1#;
   pragma Export (C, u00244, "generic_routerB");
   u00245 : constant Version_32 := 16#09d8847f#;
   ...
   u00250 : constant Version_32 := 16#124eb6c9#;
   pragma Export (C, u00250, "generic_routersB");
   u00251 : constant Version_32 := 16#d880d373#;
   pragma Export (C, u00251, "generic_routersS");
   u00252 : constant Version_32 := 16#fd2ad2f1#;
   pragma Export (C, u00252, "gnatS");
   u00253 : constant Version_32 := 16#f2886c31#;
   pragma Export (C, u00253, "gnat__command_lineB");
   u00254 : constant Version_32 := 16#c8b918ca#;
   pragma Export (C, u00254, "gnat__command_lineS");
   u00255 : constant Version_32 := 16#3791e504#;
   pragma Export (C, u00255, "ada__strings__unboundedB");
   u00256 : constant Version_32 := 16#9fdb1809#;
   pragma Export (C, u00256, "ada__strings__unboundedS");
   u00257 : constant Version_32 := 16#70f25dad#;
   pragma Export (C, u00257, "system__atomic_countersB");
   u00258 : constant Version_32 := 16#86fcacb5#;
   pragma Export (C, u00258, "system__atomic_countersS");
   u00259 : constant Version_32 := 16#5fc82639#;
   pragma Export (C, u00259, "system__machine_codeS");
   u00260 : constant Version_32 := 16#906460f4#;
   pragma Export (C, u00260, "gnat__directory_operationsB");
   u00261 : constant Version_32 := 16#b33d66bb#;
   pragma Export (C, u00261, "gnat__directory_operationsS");
   u00262 : constant Version_32 := 16#e5480ede#;
   pragma Export (C, u00262, "ada__strings__fixedB");
   u00263 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00263, "ada__strings__fixedS");
   u00264 : constant Version_32 := 16#923eb7bb#;
   pragma Export (C, u00264, "gnat__os_libS");
   u00265 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00265, "system__pool_globalB");
   u00266 : constant Version_32 := 16#7141203e#;
   pragma Export (C, u00266, "system__pool_globalS");
   u00267 : constant Version_32 := 16#ee101ba4#;
   pragma Export (C, u00267, "system__memoryB");
   u00268 : constant Version_32 := 16#6bdde70c#;
   pragma Export (C, u00268, "system__memoryS");
   u00269 : constant Version_32 := 16#3b5cd14a#;
   pragma Export (C, u00269, "ada__command_lineB");
   u00270 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00270, "ada__command_lineS");
   u00271 : constant Version_32 := 16#084c16d0#;
   pragma Export (C, u00271, "gnat__regexpS");
   u00272 : constant Version_32 := 16#908d8e33#;
   pragma Export (C, u00272, "system__regexpB");
   u00273 : constant Version_32 := 16#119226f4#;
   pragma Export (C, u00273, "system__regexpS");
   u00274 : constant Version_32 := 16#b4645806#;
   pragma Export (C, u00274, "gnat__stringsS");
   u00275 : constant Version_32 := 16#f3b30406#;
   pragma Export (C, u00275, "reduceB");
   u00276 : constant Version_32 := 16#2f22f535#;
   pragma Export (C, u00276, "reduceS");
   u00277 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00277, "system__concat_4B");
   u00278 : constant Version_32 := 16#4cc4aa18#;
   pragma Export (C, u00278, "system__concat_4S");
   u00279 : constant Version_32 := 16#d34f9f29#;
   pragma Export (C, u00279, "system__random_numbersB");
   u00280 : constant Version_32 := 16#f1b831a2#;
   pragma Export (C, u00280, "system__random_numbersS");
   u00281 : constant Version_32 := 16#40a8df0e#;
   pragma Export (C, u00281, "system__random_seedB");
   u00282 : constant Version_32 := 16#69b0a863#;
   pragma Export (C, u00282, "system__random_seedS");
   u00283 : constant Version_32 := 16#1713e61a#;
   pragma Export (C, u00283, "system__scalar_valuesB");
   u00284 : constant Version_32 := 16#8c04866f#;
   pragma Export (C, u00284, "system__scalar_valuesS");
   u00285 : constant Version_32 := 16#96bbd7c2#;
   pragma Export (C, u00285, "system__tasking__rendezvousB");
   u00286 : constant Version_32 := 16#ea18a31e#;
   pragma Export (C, u00286, "system__tasking__rendezvousS");
   u00287 : constant Version_32 := 16#6896b958#;
   pragma Export (C, u00287, "system__tasking__entry_callsB");
   u00288 : constant Version_32 := 16#df420580#;
   pragma Export (C, u00288, "system__tasking__entry_callsS");
   u00289 : constant Version_32 := 16#1dc86ab7#;
   pragma Export (C, u00289, "system__tasking__protected_objects__operationsB");
   u00290 : constant Version_32 := 16#ba36ad85#;
   pragma Export (C, u00290, "system__tasking__protected_objects__operationsS");
   u00291 : constant Version_32 := 16#d8fc9f88#;
   pragma Export (C, u00291, "system__tasking__stagesB");
   u00292 : constant Version_32 := 16#e9cef940#;
   pragma Export (C, u00292, "system__tasking__stagesS");
   u00293 : constant Version_32 := 16#f89f7823#;
   pragma Export (C, u00293, "system__val_boolB");
   u00294 : constant Version_32 := 16#c832ed26#;
   pragma Export (C, u00294, "system__val_boolS");
   u00295 : constant Version_32 := 16#83947c18#;
   pragma Export (C, u00295, "system__val_enumB");
   u00296 : constant Version_32 := 16#89bac3ad#;
   pragma Export (C, u00296, "system__val_enumS");
